...
> 学习侧现在的真实短板不是「不能动手」，而是**缺跨章的组织方式**（F7 范围 2–4 的跨文档组合 / 学习路径）。
...
| **P2** ◐ | F7 资料结构可编辑 | 把切分控制权交给用户 + 跨文档组学习路径（**范围 1 已落地 2026-09-14**；拆分 / 跨文档组合 / 前置人工调整待做） | 小~中 |
...
**无前置、可立即开工**：~~F5~~（已实施）· ~~F7~~（范围 1 已落地，范围 2–4 可续做）· ~~F8~~（范围 1 已实现，范围 2–5 可续做）
...
**部分交付**：**F5**（四项全落地 2026-09-14～09-16，D1-C/D5-C 可见性待做）· **F7**（范围 1，2026-09-14）· **F8**（范围 1，2026-09-21）
...
> 仍未做：**F8 导入覆盖面**（0 字符检测已于 2026-09-21 交付，仍开放的是 OCR / DOCX / EPUB / URL 四项）· **F7 范围 2–4**（章节拆分 / 跨文档组合 / 前置关系人工调整）· **F5 两处可见性**（D1-C 章级队列纳入到期卡 / D5-C 首页卡片入口）。
